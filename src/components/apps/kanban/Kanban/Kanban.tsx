        ...
        <Panel header="Workshop details" key="1">
          ...
          >
            <BaseButtonsForm.Item label="Title" name="workshop_title" initialValue={workshop.workshop_title}>
              <Input placeholder="Title" value={workshop.workshop_title} defaultValue={workshop.workshop_title} />
            ...
            <BaseButtonsForm.Item label="Target skills" name="target_skills">
              <Select defaultValue={workshop.target_skills} value={workshop.target_skills}>
            ...
            <BaseButtonsForm.Item label="Method" name="workshop_method">
              <Select defaultValue={workshop.workshop_method} value={workshop.workshop_method}>
            ...
            <BaseButtonsForm.Item label="Duration">
              <label>
                <BaseButtonsForm.Item name="duration">
                  <InputNumber value={workshop.duration} min={0} keyboard={true} />
                </BaseButtonsForm.Item>
              </label>
            </BaseButtonsForm.Item>
          </BaseButtonsForm>
